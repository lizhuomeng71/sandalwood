                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      ...
                      <div className="absolute right-0 bottom-0 mr-4 mb-6">
                        <a className="flex items-center font-cabinet-grotesk font-bold decoration-blue-500 decoration-2 underline-offset-2 hover:underline px-3 py-1 bg-white rounded-full shadow-xs" href="#0">
                    ...
                    <div className="relative">
                      ...
                      <div>
                        <a className="btn-sm text-white bg-blue-500 hover:bg-blue-600 group shadow-xs" href="#0">
