            ...
            <div className="md:w-1/2" data-aos-id-cards>
              <div className="flex space-x-6">
                ...
                <div className="w-1/2 space-y-6">
                  {/* Item */}
                  <div className="text-center shadow-xs" data-aos-anchor="[data-aos-id-cards]" data-aos="fade-down">
                    ...
                    <div className="bg-white px-4 pb-6">
                      ...
                      <div>
                        <a className="btn-sm text-white bg-gray-800 hover:bg-gray-900 shadow-xs" href="#0">
                  ...
                  {/* Item */}
                  <div className="text-center shadow-xs" data-aos="fade-right" data-aos-anchor="[data-aos-id-cards]" data-aos-delay="200">
                ...
                <div className="w-1/2 mt-6 space-y-6">
                  {/* Item */}
                  <div className="text-center shadow-xs" data-aos="fade-left" data-aos-anchor="[data-aos-id-cards]" data-aos-delay="100">
                  ...
                  {/* Item */}
                  <div className="text-center shadow-xs" data-aos="fade-up" data-aos-anchor="[data-aos-id-cards]" data-aos-delay="300">
