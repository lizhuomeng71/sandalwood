...
export default function ProfileBody() {
  ...
  return (
    <div
      className={`grow bg-white dark:bg-gray-900 flex flex-col md:translate-x-0 transition-transform duration-300 ease-in-out ${
      ...
      <div className="relative px-4 sm:px-6 pb-8">
        ...
        <div className="-mt-16 mb-6 sm:mb-3">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
            ...
            <div className="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
              <Image className="rounded-full border-4 border-white dark:border-gray-900" src={UserAvatar} width={128} height={128} alt="Avatar" />
            </div>
        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="inline-flex items-start mb-2">
            <h1 className="text-2xl text-gray-800 dark:text-gray-100 font-bold">Carolyn McNeail</h1>
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            <div className="flex items-center">
              <svg className="fill-current shrink-0 text-gray-400 dark:text-gray-500" width="16" height="16" viewBox="0 0 16 16">
                <path d="M8 8.992a2 2 0 1 1-.002-3.998A2 2 0 0 1 8 8.992Zm-.7 6.694c-.1-.1-4.2-3.696-4.2-3.796C1.7 10.69 1 8.892 1 6.994 1 3.097 4.1 0 8 0s7 3.097 7 6.994c0 1.898-.7 3.697-2.1 4.996-.1.1-4.1 3.696-4.2 3.796-.4.3-1 .3-1.4-.1Zm-2.7-4.995L8 13.688l3.4-2.997c1-1 1.6-2.198 1.6-3.597 0-2.798-2.2-4.996-5-4.996S3 4.196 3 6.994c0 1.399.6 2.698 1.6 3.697 0-.1 0-.1 0 0Z" />
              </svg>
              <span className="text-sm font-medium whitespace-nowrap text-gray-500 dark:text-gray-400 ml-2">Milan, IT</span>
            </div>
            <div className="flex items-center">
              <svg className="fill-current shrink-0 text-gray-400 dark:text-gray-500" width="16" height="16" viewBox="0 0 16 16">
                <path d="M11 0c1.3 0 2.6.5 3.5 1.5 1 .9 1.5 2.2 1.5 3.5 0 1.3-.5 2.6-1.4 3.5l-1.2 1.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l1.1-1.2c.6-.5.9-1.3.9-2.1s-.3-1.6-.9-2.2C12 1.7 10 1.7 8.9 2.8L7.7 4c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4l1.2-1.1C8.4.5 9.7 0 11 0ZM8.3 12c.4-.4 1-.5 1.4-.1.4.4.4 1 0 1.4l-1.2 1.2C7.6 15.5 6.3 16 5 16c-1.3 0-2.6-.5-3.5-1.5C.5 13.6 0 12.3 0 11c0-1.3.5-2.6 1.5-3.5l1.1-1.2c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4L2.9 8.9c-.6.5-.9 1.3-.9 2.1s.3 1.6.9 2.2c1.1 1.1 3.1 1.1 4.2 0L8.3 12Zm1.1-6.8c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-4.2 4.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l4.2-4.2Z" />
              </svg>
              <a className="text-sm font-medium whitespace-nowrap text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 ml-2" href="#0">
                carolinmcneail.com
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col xl:flex-row xl:space-x-16">
          ...
          <div className="flex-1 space-y-5 mb-8 xl:mb-0">
            {/* About Me */}
            <div>
              <h2 className="text-gray-800 dark:text-gray-100 font-semibold mb-2">About Me</h2>
            ...
            {/* Departments */}
            <div>
              <h2 className="text-gray-800 dark:text-gray-100 font-semibold mb-2">Departments</h2>
              {/* Cards */}
              <div className="grid xl:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex -space-x-3 -ml-0.5">
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage02} width={24} height={24} alt="Avatar" />
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage03} width={24} height={24} alt="Avatar" />
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage04} width={24} height={24} alt="Avatar" />
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage05} width={24} height={24} alt="Avatar" />
                    </div>
                    {/* Link */}
                    <div>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                  ...
                  <div className="flex justify-between items-center">
                    {/* Avatars group */}
                    <div className="flex -space-x-3 -ml-0.5">
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage06} width={24} height={24} alt="Avatar" />
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage03} width={24} height={24} alt="Avatar" />
                      <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage01} width={24} height={24} alt="Avatar" />
                    </div>
                    {/* Link */}
                    <div>
                      <a className="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">
            ...
            {/* Work History */}
            <div>
              <h2 className="text-gray-800 dark:text-gray-100 font-semibold mb-2">Work History</h2>
              <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      ...
                      {/* Position */}
                      <div>
                        <div className="font-medium text-gray-800 dark:text-gray-100">Senior Product Designer</div>
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      {/* Icon */}
                      <div className="w-8 h-8 rounded-full shrink-0 bg-violet-500 my-2 mr-3">
                        <svg className="w-8 h-8 fill-current text-violet-50" viewBox="0 0 32 32">
                      ...
                      {/* Position */}
                      <div>
                        <div className="font-medium text-gray-800 dark:text-gray-100">Product Designer</div>
                        <div className="flex flex-nowrap items-center space-x-2 whitespace-nowrap">
                          <div>Milan, IT</div>
                          <div className="text-gray-400 dark:text-gray-600">·</div>
          ...
          <aside className="xl:min-w-[14rem] xl:w-[14rem] space-y-3">
            ...
            <div className="text-sm">
              <h3 className="font-medium text-gray-800 dark:text-gray-100">Location</h3>
