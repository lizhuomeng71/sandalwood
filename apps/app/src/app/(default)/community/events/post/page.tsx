...
import EventThumb from '@/../public/images/meetups-thumb-02.jpg'
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          ...
          {/* Similar Events */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">Similar Events</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 p-5 shadow-sm rounded-xl lg:w-[18rem] xl:w-[20rem]">
            <div className="space-y-2">
              {/* Note: In production, replace 'demo-event-id' with actual event ID */}
              <Link
                href="/community/events/demo-event-id/register"
