        ...
        <div className="grow p-5">
          ...
          <header>
            <div className="flex justify-center mb-2">
              <Link className="relative inline-flex items-start" href={`/community/profile/${user.link}`}>
            ...
            <div className="text-center">
              <Link className="inline-flex text-gray-800 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white" href={`/community/profile/${user.link}`}>
