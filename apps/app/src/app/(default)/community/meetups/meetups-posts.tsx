        ...
        <div className="grow p-5 flex flex-col">
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-xs font-medium text-gray-400 dark:text-gray-500 italic">+64</div>
            </div>
          </div>
        </div>
      </article>
        ...
        <div className="grow p-5 flex flex-col">
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-xs font-medium text-gray-400 dark:text-gray-500 italic">+32</div>
            </div>
          </div>
        </div>
      </article>
