  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Dedicated form for a category of users that will perform actions? <a className="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">#viewall</a></div>
        </div>
      </div>
      {/* Footer */}
