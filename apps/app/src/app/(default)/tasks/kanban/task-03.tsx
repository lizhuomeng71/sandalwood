...
export default function Task03() {
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">Change license and remove references to products</h2>
      </div>
      {/* Footer */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          <a className="block" href="#0">
            <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage01} width={28} height={28} alt="User 03" />
          </a>
          <a className="block" href="#0">
            <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage02} width={28} height={28} alt="User 10" />
          </a>
        </div>
        {/* Right side */}
