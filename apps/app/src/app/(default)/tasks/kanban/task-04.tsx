    ...
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          <a className="block" href="#0">
            <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage01} width={28} height={28} alt="User 06" />
          </a>
        </div>
        {/* Right side */}
      ...
      <ul className="mt-3">
        <li className="flex items-center border-t border-gray-100 dark:border-gray-700/60 py-2">
          ...
          <div className="text-sm text-gray-400 dark:text-gray-500 line-through">Implement new designs</div>
        </li>
        <li className="flex items-center border-t border-gray-100 dark:border-gray-700/60 py-2">
