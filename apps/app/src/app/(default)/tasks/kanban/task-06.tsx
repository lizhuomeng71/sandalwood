...
export default function Task06() {
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-1">Design new diagrams</h2>
        {/* Content */}
        <div>
          <div className="text-sm">#7896 created by <a className="font-medium text-gray-800 hover:underline" href="#0">jerzy-wierzy</a></div>
        </div>
      </div>
      {/* Footer */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 -space-x-3 -ml-px">
          ...
          <a className="block" href="#0">
            <Image className="rounded-full border-2 border-white dark:border-gray-800 box-content" src={UserImage02} width={28} height={28} alt="User 02" />
          </a>
        </div>
        {/* Right side */}
